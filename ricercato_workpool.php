...
require 'inc/ws_ricerca_workpool.php';
$workpool=$_POST['workpool'];
$utente=$_SESSION['utente'];
$pwd=$_SESSION['pwd'];



$risultato=getRicercaWorkPool($utente, $pwd, $workpool);
			...
			<?php	if ($risultato!=null) {?>
				<div class="card text-white">
					<div class="card-body">
						...
						<label class="color-black"> Workpool trovato </label>
